...
class _JobRecommendationScreenState
    extends State<JobRecommendationScreen> {
...
Future<void> getJobs() async {
  ...
  try {
    final request = http.MultipartRequest(
      "POST",
      Uri.parse("${ApiConfig.baseUrl}/job-recommendation"),
    );
    ...
    debugPrint(
      "Job Recommendation Status : ${streamedResponse.statusCode}",
    );
    ...
    child: Padding(
      ...
      child: Column(
        ...
        children: const [
          ...
          Text(
            "Our AI is matching your resume with the most suitable job opportunities.",
    ...
    appBar: AppBar(
      ...
      actions: [
        IconButton(
          tooltip: "Refresh",
          icon: const Icon(Icons.refresh),
          onPressed: loading ? null : getJobs,
        ),
      ],
    ),
